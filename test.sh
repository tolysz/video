...
mkdir -p `dirname angularGrid.cssx` && cp -r ../bower_components/ag-grid/dist/angularGrid.css angularGrid.css
mkdir -p `dirname theme-fresh.cssx` && cp -r ../bower_components/ag-grid/dist/theme-fresh.css theme-fresh.css
mkdir -p `dirname theme-dark.cssx` && cp -r ../bower_components/ag-grid/dist/theme-dark.css theme-dark.css
mkdir -p `dirname angular-material.cssx` && cp -r ../bower_components/angular-material/angular-material.css angular-material.css

echo -e " @import url('bootstrap-fonts.css');\n @import url('font-awesome.css');\n @import url('font-tools.css');\n @import url('angularGrid.css');\n @import url('theme-fresh.css');\n @import url('theme-dark.css');\n @import url('angular-material.css');\n" > app.css
